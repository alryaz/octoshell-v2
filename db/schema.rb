...
ActiveRecord::Schema.define(version: 20180411120928) do
  ...
  create_table "core_journal_changes", force: :cascade do |t|
  ...
  add_index "core_journal_changes", ["journalable_type", "journalable_id"], name: "index_journalable_object", using: :btree

  create_table "core_journal_groups", force: :cascade do |t|
    t.integer  "parent_id"
